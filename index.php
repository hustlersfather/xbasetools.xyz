      ...
      <div class="collapse navbar-collapse order-1" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <!--li class="nav-item dropdown mr-auto">
            ...
            <!-- ... UK BANK+(Fullz Infos) ... -->
            <li class="nav-item dropdown mr-auto">
              <a class="nav-link dropdown-toggle" style="color: var(--font-color);" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="> 
          <i class="fas fa-leaf fa-sm orange-text"></i>   <small> USA BANK+AN:RN+(Login:Pass) </a>
