  ...
  <body>
    ...
    <div id="sidebar-wrapper">
      <ul class="sidebar-nav">
        <li class="sidebar-brand">
          <a href="./index">
            <div class="navbar-brand" onclick="location.href=&#39;index.html&#39;"><font color="white"><b><span class="glyphicon glyphicon-fire"></span> Seller Panel</b></font></div>
          </a>
        </li>
        ...
        <li>
          <a href="./sales.html" style="cursor: pointer;">
            Sales 
            <div id="sales" class="label label-info"></div>
          </a>
        </li>
    ...
    <div>
      ...
      <div class="well well-sm">
        Hello <span class="label label-primary"> feluxshop1</span><br>
        ...
        <br>
        <h4>Your information <small>feluxshop1</small> </h4>
        &nbsp;	&nbsp;	&bull;	Your selling nickname in this shop is <b>seller3</b> <br>
    ...
    <h4>Top Sellers <small>From Sunday (04/02) to Monday (04/08)</small></h4>
    <table class="table table-striped table-bordered table-condensed">
      ...
      <tbody>
        ...
        <tr>
          <td><b>2.</b></td>
          <td><b><span class="glyphicon glyphicon-user"></span> seller3</b></td>
          <td><b>4$</b></td>
        </tr>
        <tr>
          <td>3.</td>
    ...
    <div class="list-group" id="div2">
      ...
      <a class="list-group-item">
        <h5 class="list-group-item-heading"><b>Bugs Fixed!</b></h5>
        <h6 class="list-group-item-text">2020-03-23 22:29:26</h6>
      </a>
      <a class="list-group-item">
        <h5 class="list-group-item-heading"><b>New Accounts Addeded</b></h5>
        <h6 class="list-group-item-text">2020-03-23 22:29:14</h6>
      </a>
      <a class="list-group-item">
        <h5 class="list-group-item-heading"><b>Bugs Updated</b></h5>
        <h6 class="list-group-item-text">2020-03-23 22:28:56</h6>
      </a>
    </div>
  </body>
</html>
